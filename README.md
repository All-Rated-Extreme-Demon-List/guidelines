These are the markdown files which the [AREDL Guidelines Page](https://aredl.net/guidelines/) is built from. Feel free to open a pull request to suggest any rewordings/errors. 
